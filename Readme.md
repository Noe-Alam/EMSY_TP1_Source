...
![Interface_en_ligne_de_commande](/Images/Interface_en_ligne_de_commande.jpg)
...
rwxr-xr-x:  
> rwx --> Corréspond aux droit d'accès (propriétaire): Le propriétaire peur lire (r = read), peut écrire (w = write), peut accèder au répertoire (x = execute) 
